<!-- Plantilla para administrador
    No esta muy bien tener un componente y que ese llame a otro componente
    ya que si queremos agregar mas cosas se complicara la logica,
    Asi que nos copiamos la logica del SideBar y la pegamos aqui

(Se BORRO Este comentario porque estaba causando ERRORES)
Le damos la posibilidad de mandar el titulo, asi como arriba
-->
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <!-- Todo el contenido se regresara a esta seccion -->
        <flux:main>
            {{ $slot }}
        </flux:main>
